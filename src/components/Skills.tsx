...
export default function Skills() {
  return (
    <section id="skills" className="py-24 px-10 max-md:px-5 relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-display text-[20vw] text-white/20 [text-shadow:_0_0_40px_#fde047,_0_0_80px_#fde047,_0_0_120px_#eab308] whitespace-nowrap pointer-events-none tracking-wider">
        STACK
      </div>
